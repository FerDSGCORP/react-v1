...
const useFetchFideicomisarioPInfoMultiple = (numeroDeContrato) => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(`${uriApi}/api/fideicomisariop/infoMultiple/${numeroDeContrato}`, {
					method: 'GET',
					headers: headers,
				});
...
export default useFetchFideicomisarioPInfoMultiple;