...
const useFetchBienFideInfoMultiple = (numeroDeContrato) => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(`${uriApi}/api/bienfide/infoMultiple/${numeroDeContrato}`, {
					method: 'GET',
					headers: headers,
				});
...
export default useFetchBienFideInfoMultiple;