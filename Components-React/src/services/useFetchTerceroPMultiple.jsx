...
const useFetchTerceroPInfoMultiple = (numeroDeContrato) => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(`${uriApi}/api/tercerop/infoMultiple/${numeroDeContrato}`, {
					method: 'GET',
					headers: headers,
				});
...
export default useFetchTerceroPInfoMultiple;