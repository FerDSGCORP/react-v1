...
const useFetchCInterFidInfoMultiple = (numeroDeContrato) => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(`${uriApi}/api/cinterfid/infoMultiple/${numeroDeContrato}`, {
					method: 'GET',
					headers: headers,
				});
...
export default useFetchCInterFidInfoMultiple;