...
const useFetchFideicomitenteP = (numeroDeContrato, page = 1, rows = 80, filters = null) => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(
					`${uriApi}/api/fideicomitentep/sidx/NumeroDeContrato/sord/asc/page/${page}/rows/${rows}/${numeroDeContrato}`,
					{
						method: 'GET',
						 headers: headers,
					}
...
export default useFetchFideicomitenteP;