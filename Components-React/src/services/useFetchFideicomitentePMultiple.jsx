...
const useFetchFideicomitentePInfoMultiple = (numeroDeContrato) => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(`${uriApi}/api/fideicomitentep/infoMultiple/${numeroDeContrato}`, {
					method: 'GET',
					headers: headers,
				});
...
export default useFetchFideicomitentePInfoMultiple;