...
const useFetchCInterFidInfo = (numeroDeContrato, numeroDeSubContrato, numeroDeIntermediario, numeroDeMoneda, contratoIntermediacion) => {
	...
	useEffect(() => {
		if(!numeroDeContrato&&!numeroDeSubContrato&&!numeroDeIntermediario&&!numeroDeMoneda&&!contratoIntermediacion||!config){
			setLoading(true);
			return;
		}
		...
		fetchData();
	}, [numeroDeContrato, numeroDeSubContrato, numeroDeIntermediario, numeroDeMoneda, contratoIntermediacion, config]);
