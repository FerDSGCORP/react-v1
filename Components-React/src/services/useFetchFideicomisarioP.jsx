...
const useFetchFideicomisarioP = (numeroDeContrato, page = 1, rows = 80, filters = null) => {
		...
		const fetchData = async () => {
			...
			try {
				...
				const response = await fetch(
					`${uriApi}/api/fideicomisariop/sidx/NumeroDeContrato/sord/asc/page/${page}/rows/${rows}/${numeroDeContrato}`,
					{
						method: 'GET',
						 headers: headers,
					}
...
export default useFetchFideicomisarioP;